...
class MedioControladorCliente {
     ...
     */
    MedioControladorCliente(final Socket conexion, final Jugador jugador) { 
        if (conexion == null)
        ...
        try {
            ...
            salidaRed.writeObject(MensajeServidor.creaMensajeServidor_JugadorAsignado(this.jugador)); 
            salidaRed.flush();    
        } 
